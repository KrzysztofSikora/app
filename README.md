...
You will find OpenAPI Specification (Swagger 2.0) for the API to use with this project in `docs/schema/swagger.json`. We recommend [Swagger EditorPage](https://editor.swagger.io/) to explore it in human readable format.
